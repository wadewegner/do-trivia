...
<!-- usage -->
```sh-session
$ npm install -g digitalocean-trivia
$ do-trivia COMMAND
running command...
$ do-trivia (--version)
digitalocean-trivia/0.0.0 darwin-arm64 node-v20.15.0
...
_See code: [src/commands/hello/index.ts](https://github.com/WadeWegner/digitalocean-trivia/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/WadeWegner/digitalocean-trivia/blob/v0.0.0/src/commands/hello/world.ts)_
